<template>  
    ...
    <p style="text-align: justify;">En este sitio se encuentran los trabajos realizados a lo largo de la unidad 3, 
        de la asignatura de Programación Web, realizados por la alumna Daisy Gonzalez Lita, con número de control 
         22620056, los cuales fueron fueron revisados por el ingeniero Josué Israel Vásquez Martínez. </p>

    <p style="text-align: justify;">En esta unidad se trabajo con el framework de Vue, con la librería de Bootstrap, y con GitHub.</p>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://www.datocms-assets.com/15783/1601042117-github.png" class="d-block w-100" alt="...">
    </div>
  </div>
